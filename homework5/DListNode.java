...
public class DListNode extends ListNode {
   ...
   *  @param myList the list this node is in.
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    if (!isValidNode()) {
      ...
      DListNode temp = ((DList)myList).newNode(item, (DList) myList, this, next);
	  next.prev = temp;
	  next = temp;
	  myList.size++;}
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    if (!isValidNode()) {
      ...
      DListNode temp = ((DList)myList).newNode(item, (DList) myList, prev, this);
	  prev.next = temp;
	  prev = temp;
	  myList.size++;}
