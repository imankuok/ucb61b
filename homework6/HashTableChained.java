...
/** 
  ...
  int compFunction(int code) {
   ...
   return ((3*code + 5)%capacity + capacity)% capacity; //??//
  ...
  public Entry insert(Object key, Object value) {
    // Replace the following line with your solution.
	  Entry ent = new Entry(); // Entry = item of a node = (key, value)
	  ent.key = key;
	  ent.value=value;
	  
       int index = compFunction(key.hashCode());
       table[index].insertBack(ent);
  ...
  public Entry find(Object key) {
    // Replace the following line with your solution.
	  Entry ent = new Entry();
       ...
       int index = compFunction(key.hashCode());
       DListNode walker = (DListNode) table[index].front();
