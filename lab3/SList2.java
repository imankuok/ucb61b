...
public class SList2 {
  ...
  public static void main (String[] args) {
    // Fill in your solution for Part I here.
	 ...
	 SList2 list = new SList2();
	 
	 list.insertEnd(6);
	 list.insertEnd(9);
	 list.insertEnd(12);
	 // you cant do the front first, because you dont have the tail tag in insert head method.
  ...
  private static void testEmpty() {
    SList2 lst1 = new SList2();
    SList2 lst2 = new SList2();
    System.out.println();
